...
const bn: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "অ্যাক্সেস পাসওয়ার্ড ভুল বা প্রবেশ করা হয়নি. অনুগ্রহ করে [লগইন পৃষ্ঠা](/#/auth) এ যান এবং ChatGPT-3.5-Turbo-এর সাথে বিনামূল্যে কথোপকথন করতে আপনার অ্যাক্সেস পাসওয়ার্ড হিসেবে 'chatgpt-nice' ইনপুট করুন। বিকল্পভাবে, আপনি আপনার নিজের OpenAI API কী লিখতে [সেটিংস পৃষ্ঠা](/#/settings) এ যেতে পারেন।",
  },
  Auth: {
    Title: "একটি অ্যাক্সেস কোড প্রয়োজন",
    Tips: "নীচে অ্যাক্সেস কোড ইনপুট করুন 'chatgpt-nice'",
    Input: "অ্যাক্সেস কোড",
